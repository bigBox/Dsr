...
public class AdminIndexTag extends AbstractBaseTag {
	...
	protected String getBodyContentString(String bodyContent) {
		...
		sb.append("\t\n");
		sb.append("<span class=\"logo-mini\"><b>寻宝吧</b></span>");
		sb.append("\t\n");
		sb.append("<span class=\"logo-lg\"><b>BMS</b>后台管理</span>");
		sb.append("\t\n");
		sb.append("</a>");
		sb.append("\t\n");
		...
		sb.append("\t\n");
		sb.append("<iframe name=\"bms-iframe\" src=\""+ getContextPath() + "/admin/console" +"\" width=\"100%\" height=\"100%\" frameborder=\"no\" border=\"0\">");
		sb.append("\t\n");
		sb.append("</iframe>");
		sb.append("\t\n");
		sb.append("</div>");
		...
		sb.append("</div>");
		sb.append("\t\n");
		sb.append("<strong>Copyright © 2018-2020 <a href=\"http://xbaoba.com/\">寻宝吧</a>.</strong> All rights reserved.");
		sb.append("\t\n");
		sb.append("</footer>");
		sb.append("\t\n");
		sb.append("</div>");
