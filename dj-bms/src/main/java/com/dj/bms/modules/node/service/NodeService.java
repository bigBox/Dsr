package com.dj.bms.modules.node.service;
...
public interface NodeService extends BaseService<Node, NodeDTO>{
	 ...
	 * @param nodeDesc 节点描述
	 */
	void update(Integer nodeId, String parentNodeId, String nodeTitle, String avatarNormal, String avatarLarge, String nodeDesc);
