package com.dj.bms.modules.node.controller.admin;
...
public class NodeAdminController {
	...
	@ResponseBody
	public Result<String> edit(Integer nodeId, String parentNodeId, String nodeTitle, String avatarNormal, String avatarLarge, String nodeDesc) {
		...
		nodeService.update(nodeId, parentNodeId, nodeTitle, avatarNormal, avatarLarge, nodeDesc);
