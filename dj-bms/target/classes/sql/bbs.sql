...
CREATE TABLE `app`  (
  `app_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '应用ID',
  `app_category_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用类别ID',
  `user_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `app_category`  (
  `app_category_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '应用类别ID',
  `user_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `comment`  (
  `comment_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评论ID',
  `post_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '帖子ID',
...
CREATE TABLE `follow`  (
  ...
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '关注表' ROW_FORMAT = Compact;
...
CREATE TABLE `menu`  (
  ...
  `menu_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '点击菜单时的请求 URL',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = Compact;
...
CREATE TABLE `module`  (
  ...
  `module_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '模块编码',
  `module_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '模块名称',
...
CREATE TABLE `node`  (
  ...
  `parent_node_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父节点',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '节点表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of node
-- ----------------------------
INSERT INTO `node` VALUES (1, 'notice', 'Notice', '公告', '/resources/images/node/internet_normal.png', '/resources/images/node/internet_mini.png', NULL, 1, '/n/Notice', '公告', '2020-06-22 11:00:00', '2020-06-22 11:00:00', 0, 0, 0, 0);
INSERT INTO `node` VALUES (2, 'discuss', 'Discuss', '讨论区', '/resources/images/node/android_normal.png', '/resources/images/node/android_mini.png', NULL, 1, '/n/Discuss', '讨论区', '2020-06-22 11:00:00', '2020-06-22 11:00:00', 0, 0, 0, 0);
INSERT INTO `node` VALUES (3, 'contact', 'Contact', '联系客服', '/resources/images/node/db_normal.png', '/resources/images/node/db_mini.png', NULL, 1, '/n/Contact', '联系客服', '2020-06-22 11:00:00', '2020-06-22 11:00:00', 0, 0, 0, 0);
...
INSERT INTO `permission` VALUES (47, '权限创建', 'permission:add', NULL, 8, '2019-03-05 16:11:20', NULL);
INSERT INTO `permission` VALUES (48, '节点添加', 'node:add', NULL, 6, '2019-03-03 14:25:12', NULL);
...
CREATE TABLE `post`  (
  ...
  INDEX `key_user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '帖子表' ROW_FORMAT = Compact;
...
CREATE TABLE `resource`  (
  ...
  `resource_value` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '资源值',
  `resource_desc` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '资源描述',
  `is_disabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否禁用（0：启用，1：禁用）',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除（0：有效，1：删除）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资源表' ROW_FORMAT = Compact;
...
CREATE TABLE `resource_category`  (
  `resource_category_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资源类别ID',
  `user_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源类别表' ROW_FORMAT = Compact;
...
CREATE TABLE `resource_type`  (
  `resource_type_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资源类型ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源类型表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色用户关联表' ROW_FORMAT = Compact;
...
CREATE TABLE `sidebar`  (
  `sidebar_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '侧边栏ID',
  `parent_sidebar_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级侧边栏ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '侧边栏表' ROW_FORMAT = Compact;
...
CREATE TABLE `system`  (
  `system_id` bigint(20) NOT NULL COMMENT '系统ID',
  `system_name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '系统名称',
  `system_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '系统名称',
  `is_disabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否禁用（0：启用，1：禁用）',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除（0：有效，1：删除）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`system_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统表' ROW_FORMAT = Compact;
...
INSERT INTO `system_config` VALUES (9, 'base_url', 'http://localhost:8383', '网站部署后访问的域名，注意这个后面没有 \"/\"', 1, 'text', NULL, 0, 0);
...
CREATE TABLE `tab`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '父板块表' ROW_FORMAT = Compact;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '202cb962ac59075b964b07152d234b70', '1', NULL, 10, '/resources/images/default-avatar.jpg', NULL, NULL, NULL, NULL, 0, '2021-07-07 10:34:23', NULL, 0, NULL, '1000', NULL, NULL, NULL, NULL);
...
CREATE TABLE `user_role_rel`  (
  `user_role_rel_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
