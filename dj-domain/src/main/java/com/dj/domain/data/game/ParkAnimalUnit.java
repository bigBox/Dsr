...
public class ParkAnimalUnit {
    ...
    public ParkAnimal toParkAnimal(ConfigFarmParkAnimal config) {
        Date nowTime = DateUtil.getCurrentDate();
        ParkAnimal.Builder builder = ParkAnimal.newBuilder();
        ...
        int  leftSeconds = 0;
        if(status == ParkStatus.Normal_VALUE) {
