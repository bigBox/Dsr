...
public class ConfigRobEvent{
	
	/**
	 * @Field ID : 编号 & 说明.第一个1无意义（让后面好出现001），101塞外江南，102茶马古道。。（最多到499）。，第一个01表示第二层，再一个05表示出宝、06、珍稀植物；07、珍稀动物；08、珍稀鱼，后面是指定地图指定层的具体产出编号；09、宝贝
	 */
	protected int ID;
