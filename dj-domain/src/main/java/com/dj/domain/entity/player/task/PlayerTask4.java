...
public class PlayerTask4 extends BaseEntity implements Comparable<PlayerTask4>, ITask {

	private static final long serialVersionUID = -2905844366060723045L;

	public PlayerTask4(long roleID) {
		super(roleID);
	}
...
//	}
	...
	@Override
	public IEntity copy() {
		PlayerTask4 item = new PlayerTask4();
		copySuper(item);
		item.setId(id);
	...
	@Override
	public int compareTo(PlayerTask4 verify) {
...
//			}
	...
	public boolean checkFinish(ConfigTasks config) {
		if ((actionType != TaskActionEnum.NEED_ITEM.ordinal())
