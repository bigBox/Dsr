...
public class PlayerShowTableMoney extends BaseEntity {

	private static final long serialVersionUID = -8768313217764652909L;

	public PlayerShowTableMoney(long roleID) {
		super(roleID);
	}
	...
	@Override
	public IEntity copy() {
		PlayerShowTableMoney item = new PlayerShowTableMoney();
		copySuper(item);
		item.setTitle(title);
