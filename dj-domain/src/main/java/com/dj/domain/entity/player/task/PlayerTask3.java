...
public class PlayerTask3 extends BaseEntity implements Comparable<PlayerTask3>, ITask {

	private static final long serialVersionUID = 8531055934975528922L;

	public PlayerTask3(long roleID) {
		super(roleID);
	}
...
//	}
	...
	@Override
	public IEntity copy() {
		PlayerTask3 item = new PlayerTask3();
		copySuper(item);
		item.setId(id);
	...
	@Override
	public int compareTo(PlayerTask3 verify) {
	...
	public TaskInfo toTaskInfo() {
		...
		if(taskID > 0){
			...
			builder.setType(ETaskType.Month);
