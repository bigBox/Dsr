...
public class PlayerTask1 extends BaseEntity implements Comparable<PlayerTask1>, ITask {

	private static final long serialVersionUID = -1966656744350638372L;

	public PlayerTask1(long roleID) {
		super(roleID);
	}
...
//	}
	...
	@Override
	public IEntity copy() {
		PlayerTask1 item = new PlayerTask1();
		copySuper(item);
		item.setId(id);
	...
	@Override
	public int compareTo(PlayerTask1 verify) {
	...
	public TaskInfo toTaskInfo() {
		...
		if (taskID > 0) {
			...
			builder.setType(ETaskType.GrowUp);
