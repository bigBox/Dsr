 ...
 * @since 0.9
 */
public class ToolUserFilter extends AccessControlFilter {

	/**
	 * Returns <code>true</code> if the request is a
	 * {@link #isLoginRequest(ServletRequest, ServletResponse) loginRequest} or if
	 * the current {@link #getSubject(ServletRequest, ServletResponse) subject} is
	 * not <code>null</code>, <code>false</code> otherwise.
	 *
	 * @return <code>true</code> if the request is a
	 *         {@link #isLoginRequest(ServletRequest, ServletResponse) loginRequest}
	 *         or if the current {@link #getSubject(ServletRequest, ServletResponse)
