...
import com.dj.servertool.core.common.constant.cache.CacheKey;
import com.dj.servertool.core.common.constant.state.ManagerStatus;
import com.dj.servertool.core.common.constant.state.MenuStatus;
...
import com.dj.servertool.module.mapper.DictTypeMapper;
...
public class ConstantFactory implements IConstantFactory {
	...
	private SiteNoticeMapper noticeMapper = SpringContextHolder.getBean(SiteNoticeMapper.class);
	...
	public String getNoticeTitle(Long dictId) {
		if (ToolUtil.isEmpty(dictId)) {
			...
			SiteNotice notice = noticeMapper.selectById(dictId);
			if (notice == null) {
				return "";
			} else {
