...
/**
 * @author zcq
 * @ClassName: PlayerActionHandler
 * @Description: 玩家服行为处理器
 * @date 2019年8月7日
 */
public class PlayerActionHandler extends ActionAdapter<BaseActionManager, IChannelServerManager> {

    public PlayerActionHandler(BaseActionManager actionManager, IChannelServerManager channelManager) {
